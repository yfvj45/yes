...
time.sleep(2)
print("playlist")
driver.execute_script("window.open('about:blank','ttab');")
...
print('Link_Play')
time.sleep(3)
driver.execute_script("window.open('about:blank','fftab');")
driver.switch_to.window("fftab")
driver.get("https://youtu.be/1V-tQzN6Azw")
print('Link_Play')
time.sleep(3)
driver.execute_script("window.open('about:blank','stab');")
driver.switch_to.window("stab")
driver.get("https://youtu.be/-kSxVQghbY0")
print('Link_Play')
time.sleep(3)
driver.execute_script("window.open('about:blank','setab');")
driver.switch_to.window("setab")
